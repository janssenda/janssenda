...
public class FileHandler {
    ...
    public Map<String, String> readPricingFromFile() throws FileIOException {
        ...
        File f = new File(getClass().getClassLoader().getResource("priceData.csv").getFile());
    ...
    public List<Product> readInventoryFromFile() throws FileIOException {
        ...
        File f = new File(getClass().getClassLoader().getResource("inventoryData.csv").getFile());
