 ...
 * @author Danimaetrix
 */
public class VendingMashineInventoryDaoImplTest {

    VendingMashineInventoryDaoStubImpl dao = new VendingMashineInventoryDaoStubImpl();

    public VendingMashineInventoryDaoImplTest() {
    }
