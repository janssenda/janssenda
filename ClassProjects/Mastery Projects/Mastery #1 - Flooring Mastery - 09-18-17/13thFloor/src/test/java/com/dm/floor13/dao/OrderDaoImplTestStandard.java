 ...
 * @author Danimaetrix
 */
public class OrderDaoImplTestStandard {

    String dataDirectroy = "./data/orders/test_files/daoTestData";
    String orderDirectory = dataDirectroy + "/testData/";
    String unModDirectory = dataDirectroy + "/unModifiedData/";
    ...
    public OrderDaoImplTestStandard() {
    }

    @Before
    public void setUp() {
        copyDirAndFiles(unModDirectory, orderDirectory);
        this.orderMap = orderDao.readAllOrdersFromDirectory(orderDirectory);    }
    ...
    public void testReadData() {
        try {
            stateDao.readDataFromFile(statesFile);
            productDao.readDataFromFile(productsFile);
...
//
    ...
    public void testAddOrder() {
        ...
        try {
            ...
            orderMap.clear();
            orderMap = orderDao.readAllOrdersFromDirectory(orderDirectory);
...
//
        ...
        try {
            orderDao.removeOrder(orderDao.getOrder("16826").get(0));
...
//
        ...
        String filename = dataDirectroy + "/testData/" + "Orders_05082011.csv";
        ...
        String filename2 = dataDirectroy + "/testData/" + "Orders_05082011.csv";
        if (new File(filename).exists()) {
            //fail("File should have been removed");
        }
//
        // Make sure the temp data file was removed
        filename = dataDirectroy + "/testData/tmp/" + "16826_temp.csv";
        if (new File(filename).exists()) {
            fail("File should have been removed");
        }
