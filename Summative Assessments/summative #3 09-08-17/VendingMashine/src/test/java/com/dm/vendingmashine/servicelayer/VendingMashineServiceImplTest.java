...
import com.dm.vendingmashine.dao.VendingMashineInventoryDaoStubImpl;
import com.dm.vendingmashine.dao.VendingMashinePricingDaoStubImpl;
 ...
 * @author Danimaetrix
 */
public class VendingMashineServiceImplTest {

    // Instansiate our fake DAO's and the service layer
    VendingMashineInventoryDaoStubImpl daoInv = new VendingMashineInventoryDaoStubImpl();
    VendingMashinePricingDaoStubImpl daoPrice = new VendingMashinePricingDaoStubImpl();
    VendingMashineServiceImpl service = new VendingMashineServiceImpl(daoInv, daoPrice);

    public VendingMashineServiceImplTest() {
    }
